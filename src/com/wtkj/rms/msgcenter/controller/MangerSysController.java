...
@Controller
@RequestMapping("/managersys")
/**
 * @author sunsi
 *
 */
public class MangerSysController extends ArticleController {

	// TODO 配置文件读取或者数据库读取
	public static final String TAG = "managersys";
	public static final String CODE = "glzd";
