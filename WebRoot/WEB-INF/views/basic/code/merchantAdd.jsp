	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="merchantAddForm" method="post">
			<table class="grid" border="1">
				...
				<tr>
					<td>服务商名称 
					<label style="color: red; vertical-align: middle; text-align: center;">*
						</label>
					</td>
					<td colspan="3"><input name="name" type="text" data-options="required:true"
				...
				<tr>
					<td>服务商网址 <label
						style="color: red; vertical-align: middle; text-align: center;"></label></td>
					<td colspan="3"><input name="website" type="text"
				...
				<tr>
					...
					<td>电子邮件 <label
						style="color: red; vertical-align: middle; text-align: center;">*</label></td>
					<td><input name="email" type="text"  data-options="required:true"
