...
<script type="text/javascript">
	...
	function detailFun() {
		...
		parent.$.modalDialog({
			...
			width : '815',
			height : '500',
			href : '${ctx}/contract/detailPage?id=' + id,
			buttons : [ {
				text : '退出',
				handler : function() {
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" class="mygrid-toolbar" style="inline:true">
		...
		<c:choose>
			<c:when test="${fn:contains(sessionInfo.resourceList, '/contract/add')}">
		...
		<c:choose>
			<c:when test="${fn:contains(sessionInfo.resourceList, '/contract/edit')}">
		...
		<c:choose>
			<c:when test="${fn:contains(sessionInfo.resourceList, '/contract/delete')}">
		...
		<c:choose>
			<c:when test="${fn:contains(sessionInfo.resourceList, '/contract/detail')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/contract/search')}">
			<div id="searchbar" class = "search-toolbar">
				...
				<span>签订时间:</span> 
				<input class="Wdate" type="text" name="signTime"
						id="signTime" style="width: auto; height: 100%"
