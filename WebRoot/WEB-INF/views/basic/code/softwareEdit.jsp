...
<script type="text/javascript">
	$(function() {
		$('#softwareEditForm').form({
			url : '${pageContext.request.contextPath}/software/edit',
			onSubmit : function() {
				progressLoad();
	...
	$('#softwareVendorId').combobox({
		...
		valueField : 'id',
		value : '${software.softwareVendorId}',
		textField : 'name',
		panelHeight : 'auto'
	});
	...
	$('#contactDeveloperId').combobox({
		...
		valueField : 'id',
		value : '${software.contactDeveloperId}',
		textField : 'name',
		panelHeight : 'auto'
	});
	...
	$('#maintenancePMId').combobox({
		url : "${pageContext.request.contextPath}/user/combox",
		valueField : 'id',
		value : '${software.maintenancePMId}',
		textField : 'name',
		panelHeight : 'auto'
	});
	...
	$('#maintenanceServiceId').combobox({
		url : "${pageContext.request.contextPath}/merchant/combox",
		valueField : 'id',
		value : '${software.maintenanceServiceId}',
		textField : 'name',
		panelHeight : 'auto'
	});
</script>
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="softwareEditForm" method="post"
			...
			<table class="grid">
				<tr>
					...
					<td colspan="3">
						<input type="hidden" name="attachmentIds" id="attachmentIds" value="${software.attachmentIds}"> 
						<input type="hidden" name="id" id="id" value="${software.id}">
						<input name="name" value="${software.name}" style="width: 100%; height: 100%"
				...
				<tr>
					...
					<td><input name="maintenancePeriod" type="text"
						value="${software.maintenancePeriod}" id="maintenancePeriod"
