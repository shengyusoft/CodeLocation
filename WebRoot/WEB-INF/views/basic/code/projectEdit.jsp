			...
			<table class="grid">
				<tr>
					...
					<td><input type="hidden" name="attachmentIds"
						...
						name="code" type="text" style="width: 98%" id="code"
						value="${project.code}" class="easyui-validatebox span2"
				...
				<tr>
					...
					<td><input class="Wdate" type="text" name="startDT"
						...
						data-options="required:true" value="${project.startDT}"
				...
				<tr>
					...
					<td><input class="Wdate" type="text" name="checkDT"
						...
						data-options="required:true" value="${project.checkDT}"
						onfocus="showDate('yyyy-MM-dd')" /></td>
				</tr>
				...
				<tr>
					...
					<td><input name="contactPhone" type="text"
						style="width: 98%" value="${project.contactPhone}"
						class="easyui-validatebox span2"></td>
				...
				<tr>
					...
					<td colspan="3"><textarea rows="5" name="summry"
							style="width: 98%;">${project.summry}</textarea></td>
				</tr>
			</table>
		</form>
