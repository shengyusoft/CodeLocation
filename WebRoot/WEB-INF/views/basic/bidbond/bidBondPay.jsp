...
<script type="text/javascript">
	...
	function viewFun(viewType) {
		var me = this;
		var title = '', href = '${ctx}/bidBond/viewPage?type=0&viewType='
				+ viewType;
		var buttons = [];
		if ('add' == viewType) {
			title = '投标保证金缴纳申请登记';
	...
	function submitForm() {
		...
		var f = parent.$.modalDialog.handler.find('#bidBondPayViewForm');
		f.submit();
	}
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" class="mygrid-toolbar" style="inline: true">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/bidBond/print')}">
