		...
		<form id="bidBondBackHandlerForm" method="post"
			...
			<table class="grid">
				...
				<tr style="background-color: rgba(128, 128, 128, 0.15);">
					<th style="background-color: rgba(128, 128, 128, 0.15);">到帐金额</th>
					<td colspan="5"><input name="toAccountFee"
						value="${bidBond.toAccountFee}" type="text" id="toAccountFee"
						style="width: 100%; height: 100%; background-color: rgba(128, 128, 128, 0.15);"
						class="easyui-numberbox" readonly="readonly" /></td>
				</tr>
				<tr style="background-color: rgba(128, 128, 128, 0.15);">
					<th style="background-color: rgba(128, 128, 128, 0.15);">到帐时间</th>
