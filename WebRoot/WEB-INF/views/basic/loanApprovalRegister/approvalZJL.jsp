...
<script type="text/javascript">
	$(function(){
		$('#loanApprovalRegisterApprovalZJLForm').form({
			url : '${pageContext.request.contextPath}/loanApprovalRegister/approvalZJL',
			onSubmit : function() {
				// 表单验证
				progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="loanApprovalRegisterApprovalZJLForm" method="post">
			<!-- 主键 -->
			...
			<table class="grid">
				...
				<tr>
					<th width="120px">
						总经理审批意见  &nbsp;<label style="color: red; vertical-align: middle; text-align: center;">*</label>
					</th>
					<td colspan="2">
