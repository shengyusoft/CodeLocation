			...
			<table class="grid">
				<tr>
					...
					<td><input type="hidden" name="id" id="id"
						value="${supplier.id}"> <input name="name"
				...
				<tr>
					...
					<td><input name="phone" style="width: 100%; height: 100%"
						value="${supplier.phone}" type="text" id="phone"
						class="easyui-validatebox span2" /></td>
				</tr>
				<tr>
					<th>简介&nbsp;</th>
					<td colspan="3"><textarea style="width: 100%" rows="5"
							name="remark">${supplier.remark}</textarea></td>
				</tr>
			</table>
		</form>
	</div>
