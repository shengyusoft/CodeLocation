...
<script type="text/javascript">
	...
	loadpurchasePlans();
	$(function() {
		$('#purchasePlanEditForm').form({
			url : '${pageContext.request.contextPath}/purchasePlan/edit',
			onSubmit : function() {
				progressLoad();
	...
	$('#customer').combobox({
		...
		valueField : 'id',
		value : '${purchasePlan.customer.id}',
...
<div class="easyui-layout" data-options="fit:true,bpurchasePlan:false">
	<div data-options="region:'north'" style="width: 900px; height: 75px"
		...
		<form id="purchasePlanEditForm" method="post"
			...
			<table class="grid">
				<tr>
					...
					</select> <input type="hidden" name="id" id="purchasePlan_id" value="${purchasePlan.id}"></td>
					
					<th>添加时间</th>
					<td colspan="3"><input class="Wdate" type="text" readonly="readonly" 
						name="updateDt" id="updateDt" style="width: 98%; height: 100%"
						value="${purchasePlan.addDt}" disabled="disabled"
