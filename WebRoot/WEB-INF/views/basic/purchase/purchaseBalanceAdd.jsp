...
<script type="text/javascript">
	...
	var dataGrid2;
	$(function() {
		$('#purchaseBalanceAddForm').form({
			url : '${pageContext.request.contextPath}/purchaseBalance/add',
			onSubmit : function() {
				progressLoad();
...
<div class="easyui-layout" data-options="fit:true,bpurchaseBalance:false">
	<div data-options="region:'north'" title="报价单基本信息"
		...
		<form id="purchaseBalanceAddForm" method="post"
			...
			<table class="grid">
				<tr>
					...
					</select> <input type="hidden" name="id" id="purchaseBalance_id"
