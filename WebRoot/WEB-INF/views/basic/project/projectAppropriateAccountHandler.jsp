			...
			<table class="grid">
				...
				<tr>
					...
					<td><input id="projectAppRegId" type="hidden"
						...
						name="toAccountFee" value="${projectAppropriateAccount.toAccountFee}" readonly="readonly"
					...
					<td><input name="toAccountDT"
						...
						style="width: 100%; height: 100%" id="toAccountDT"
						readonly="readonly" class="Wdate" type="text" /></td>
