...
<script type="text/javascript">
	...
	function detailFun() {
		...
		parent.$.modalDialog({
			...
			width : '815',
			height : '500',
			href : '${ctx}/goods/detailPage?id=' + id,
			buttons : [ {
				text : '退出',
				handler : function() {
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" class="mygrid-toolbar" style="inline: true">
		...
		<c:choose>
			<c:when test="${fn:contains(sessionInfo.resourceList, '/goods/add')}">
		...
		<c:choose>
			<c:when
				test="${fn:contains(sessionInfo.resourceList, '/goods/edit')}">
		...
		<c:choose>
			<c:when
				test="${fn:contains(sessionInfo.resourceList, '/goods/delete')}">
		...
		<c:choose>
			<c:when
				test="${fn:contains(sessionInfo.resourceList, '/goods/detail')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/goods/search')}">
