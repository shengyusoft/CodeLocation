...
<script type="text/javascript">
	$(function() {
		$('#bidBondGzzfBackViewForm')
				.form(
						{
							url : '${pageContext.request.contextPath}/bidBondGzzf/save?viewType=${viewType}',
							onSubmit : function() {
								progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="bidBondGzzfBackViewForm" method="post">
			<table class="grid">
				<tr>
					<td colspan="6">
						<table class="grid"
				...
				<tr>
					<th colspan="2" width="150px">付款人&nbsp;<label
						style="color: red; vertical-align: middle; text-align: center;">*</label></th>
