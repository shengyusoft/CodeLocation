...
<script type="text/javascript">
	$(function(){
		$('#businessCostApprovalRegisterApprovalCNForm').form({
			url : '${pageContext.request.contextPath}/businessCostApprovalRegister/approvalCN',
			onSubmit : function() {
				// 表单验证
				progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="businessCostApprovalRegisterApprovalCNForm" method="post">
			<!-- 主键 -->
			...
			<table class="grid">
				...
				<tr>
					<th>备注 &nbsp;</th>
					<td colspan="3">
						<textarea class="easyui-validatebox span2" style="width: 100%" rows="2" name="tellerRemark"></textarea>
					</td>
				</tr>
