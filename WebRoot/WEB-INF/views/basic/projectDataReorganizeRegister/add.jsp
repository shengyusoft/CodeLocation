...
<script type="text/javascript">
	$(function() {
		$('#projectDataReorganizeRegisterAddForm').form({
			url : '${pageContext.request.contextPath}/projectDataReorganizeRegister/add',
			onSubmit : function() {
				// 表单验证
				progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="projectDataReorganizeRegisterAddForm" method="post">
			<!-- 标段多选 -->
