...
<div style="padding: 3px;">
	<form id="resourceAddForm" method="post">
		<table class="grid">
			...
			<tr>
				<td>资源路径</td>
				<td><input name="url" type="text" class="easyui-validatebox span2" data-options="width:140,height:29" ></td>
				<td>排序</td>
				<td><input name="seq" value="0"  class="easyui-numberspinner" style="width: 140px; height: 29px;" data-options="editable:false,required:true"></td>
			</tr>
			<tr>
				<td>菜单图标</td>
